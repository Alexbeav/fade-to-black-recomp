...
static const PsxrecompCodegenHostConfig kCodegenConfig = {
    ...
    .project_root_env = "FADE_TO_BLACK_RECOMP_PROJECT_ROOT",
    .build_dir_env = "FADE_TO_BLACK_RECOMP_BUILD_DIR",
    .force_setup_env = "FADE_TO_BLACK_RECOMP_FORCE_SETUP",
    .psxrecomp_cli_relpath = "psxrecomp/psxrecomp_cli.py",
    .seed_cfg_relpath = "game.toml",
    .game_toml_relpath = "game.toml",
    .gen_marker_relpath = "generated/SLUS_002.36_dispatch.c",
    .build_dir_name = "build-release",
    .cmake_target = "psx-runtime",
    .exe_basename = "fade_to_black__Recompiled",
    .prepare_note =
