# Fade to Black Recompiled
<!-- retcomm-readme-metrics -->
[![GitHub downloads (all assets, all releases)](https://img.shields.io/github/downloads/Alexbeav/fade-to-black-recomp/total)](https://github.com/Alexbeav/fade-to-black-recomp/releases)
[![GitHub downloads (latest release)](https://img.shields.io/github/downloads/Alexbeav/fade-to-black-recomp/latest/total)](https://github.com/Alexbeav/fade-to-black-recomp/releases/latest)
[![GitHub release](https://img.shields.io/github/v/release/Alexbeav/fade-to-black-recomp)](https://github.com/Alexbeav/fade-to-black-recomp/releases/latest)
<!-- /retcomm-readme-metrics -->

Static recompilation of **Fade to Black** built on
[psxrecomp](https://github.com/Alexbeav/psxrecomp) and
[recomp-ui](https://github.com/mstan/recomp-ui).

A native recompilation setup host for Fade to Black.
...
Zip prefix for CI artifacts: `Fade-to-Black-Recomp`.
...
The `v0.3.3` source uses `Fade_to_Black_Recompiled` in CMake, the setup relaunch, and the packager.
