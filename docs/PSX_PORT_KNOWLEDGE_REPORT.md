# Fade to Black knowledge report

- Date: 2026-08-31
- Retail identity: USA NTSC-U `SLUS-00236`
...
The source now uses `Fade_to_Black_Recompiled` as the only setup executable name. The batch source
