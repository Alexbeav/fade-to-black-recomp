# Fade to Black release feasibility
...
The supported serial set is $(@{ordinal=18; slug=fade-to-black; title=Fade to Black; serials=System.Object[]; expected_disc_count=1; identity_complete=True; risks=System.Object[]}.serials -join ', '). The package uses
